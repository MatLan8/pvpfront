...
import type { PlayerEvaluation } from "../../types/aiReport";
...
interface Props {
    playerReport: PlayerEvaluation
}

function PlayerTab({ playerReport }: Props) {
    ...
    const skillCards = [
        { title: "Communication", data: playerReport.skills.communication },
        { title: "Teamwork", data: playerReport.skills.teamwork },
        { title: "Problem Solving", data: playerReport.skills.problemSolving },
        { title: "Leadership", data: playerReport.skills.leadership },
        { title: "Time Management", data: playerReport.skills.timeManagement },
    ];
        ...
        <div className={styles.container}>
            <header className={styles.hero}>
                <div>
                    ...
                    <h1 className={styles.pageTitle}>
                        {playerReport.nickname || "Player"}'s Report
                    </h1>
            ...
            <section className={styles.topSection}>
                <div className={styles.chartCard}>
                    <h2 className={styles.cardTitle}>All Skills</h2>
            ...
            <section className={styles.skillsSection}>
                <h2 className={styles.sectionHeading}>Skills Breakdown</h2>
