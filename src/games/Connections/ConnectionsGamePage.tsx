              ...
              <ul className={styles.playerList}>
                {publicState.players.map((player) => {
                  ...
                  return (
                    <li
                      key={player.playerId}
                      className={`${styles.playerItem} ${gamePlayer?.isReady ? styles.playerItemReady : ""
                        }`}
                    >
                ...
                >
                  ...
                  {gameState && (
                    <div className={styles.mistakesBadge}>
                      <span className={styles.mistakesLabel}>Mistakes left:</span>
                      <span className={styles.mistakesValue}>{mistakesLeft}</span>
                    </div>
                  )}
                </div>
              )}
            ...
            {!hasStarted || !gameState ? (
              ...
              <>
                <div className={styles.selectionHeader}>
                  ...
                  <button
                    className={`${styles.readyButton} ${isReady
